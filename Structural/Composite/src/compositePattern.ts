...
const speakersPriceInput = <HTMLInputElement>document.getElementById("speakers-price");
const speakersQuantityInput = <HTMLInputElement>document.getElementById("speakers-quantity");
const turntablesPriceInput = <HTMLInputElement>document.getElementById("turntables-price");
const turntablesQuantityInput = <HTMLInputElement>document.getElementById("turntables-quantity");

const notebookPriceInput = <HTMLInputElement>document.getElementById("notebook-price");
const notebookQuantityInput = <HTMLInputElement>document.getElementById("notebook-quantity");
const textbookPriceInput = <HTMLInputElement>document.getElementById("textbook-price");
const textbookQuantityInput = <HTMLInputElement>document.getElementById("textbook-quantity");
...
class Store implements ProductComponent {
